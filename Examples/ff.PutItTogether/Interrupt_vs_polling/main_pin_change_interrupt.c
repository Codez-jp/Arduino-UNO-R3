...
#define MY_PCICR    (*(volatile unsigned char *)(0x68))
// PCMSK2 - Pin Change Mask Register 2
#define MY_PCMSK2   (*(volatile unsigned char *)(0x6D))
// PCMSK1 - Pin Change Mask Register 1
#define MY_PCMSK1   (*(volatile unsigned char *)(0x6C))
// PCMSK0 - Pin Change Mask Register 0
#define MY_PCMSK0   (*(volatile unsigned char *)(0x6B))
...
/* Internal interrupts
*
* PCICR(The Pin Change Interrupt Control Register)
* BIT  7       6       5       4       3       2       1       0
* R/W  -       -       -       -       -       PCIE2   PCIE1   PCIE0
* GROUP                                        PORT-D  PORT-C  PORT-B
*                                              0b00000100
*   PCIE<2:0>(3) <- Pin Change Interrupt Enable
*     0: Disable
*     1: Enable
*
* PCMSK2(The Pin Change Mask Register 2) <-- PORT-D
* BIT  7       6       5       4       3       2       1       0
* R/W  PCINT23 PCINT22 PCINT21 PCINT20 PCINT19 PCINT18 PCINT17 PCINT16
* PORT PD7     PD6     PD5     PD4     PD3     PD2     PD1     PD0
* SILK D7      D6      D5      D4      D3      D2      D1      D0
* PIN  7       6       5       4       3       2       1       0
*                                      |       |
*                                      NC      +-+--> BUTTON
*                                              0b00000100
*   PCINT<23:16>(8) <- Pin Change Enable Mask
*     0: Disable
*     1: Enable
*
* PCMSK1(The Pin Change Mask Register 1) <-- PORT-C
* BIT  7       6       5       4       3       2       1       0
* R/W  PCINT14 PCINT13 PCINT12 PCINT11 PCINT10 PCINT9  PCINT8  PCINT7
* PORT -       RESET   PC5     PC4     PC3     PC2     PC1     PC0
* SILK -       RESET   A5      A4      A3      A2      A1      A0
* PIN  -       RESET   19      18      17      16      15      14
*                                                              |
*                                                              NC
* PCMSK0(The Pin Change Mask Register 0) <-- PORT-B
* BIT  7       6       5       4       3       2       1       0
* R/W  PCINT7  PCINT6  PCINT5  PCINT4  PCINT3  PCINT2  PCINT1  PCINT0
...
// #############################################################################
// #############################################################################
volatile unsigned char led_state = LOW;
volatile unsigned char buzzer_state = LOW;


int toggleState( unsigned char pin ) {
    if( pin == LED ) {
        led_state = !led_state;
        return led_state;
    }
...
//   detect button pressed and toggle buzzer
//   PORT-D pin change interrupt
...
//    digitalWrite( BUZZER, !digitalRead( BUTTON ) );
    ...
    // toggle LED
    digitalWrite( LED, toggleState( LED ) );
 
    // delay VR value ms
//    int vr_value = analogRead( VR );
    delay( 500 );
}
